...
The process of building this project was extremely difficult. Originally, I had planned to build this project using some form of wood, but due to the COVID-19 lockdown and being put out of work, I had to drastically reduce my original budget. It was because of this that I chose to use carboard and bamboo sticks. These were substancially cheaper. I used other items such as glue and double sided-tape. I already had paint and spray paint so I was able ot use them to attempt to make the box look more presentable. The building process took several days due to the slow process of waiting for paint a glue to dry. However, in the end, I was extrmeely happy with the overall result given the circumstances. 

In the end, this project successfully achieves the overall intent. The original intent was to create something that would alert people when they should drink water. This successfully does that. The user places their water bottle into the water bottle compartment. They then press button A to activate the countdown timer. In the display video, I set the timer to 15 seconds so that I could display what the output would be without the viewers having to wait 10 minutes for it to take place. Once the time is up, the servo motor activates, which moves the sign back and forth whislt a string is displayed on the screen. Once the person has finished drinking, they press button B, which then stops the servo motor and displays a string prasiing the user for drinking the water. It then resets and repeats the same process. 
...
I found every source that I have linked extremely useful. One part that I struggled with subtancially was creating the code for this project. This was because in the beginning, I did not have any idea where to begin. This was where the related projects came in handy. I went to each of these related projects and studied the codes that were used in them. As each of these projects had some similarity to my project, I found that each project answered different questions that I had. related project 1 taught me how to code for the servo motor, whereas related project 2 taught me how to create an "alarm" system. Although this wasn't exactly what I was creating, I was able to use it as inspiration to help me gain a further understanding to what parts of the code control what. 

I also found that using the technique of creating a part of code and then downloading it to test was extremely beneficial. Rather than creating the whole code together, I would add small sections that would create a new output and then I would download it onto the micro:bit and test it. This allowed for me to easily spot where the issue was in my code rather than having to look through a large amount of code and figure out what small section is preventing the rest of the code from working. 

What parts of your project do you feel are novel? This is IMPORTANT to help justify a key component of the assessment rubric.

In today's society, there are several different water hydration reminder systems present. However, when going through and analysing all of these reminder systmes, it is evident that majority of them are in the form of an app. Although this can be effective, This can also not alwyas achive the goal. Not all invidiuals have their phone on them and even when users do have their phones on them, all it takes is a quick swipe and the "reminder" is gone. This project is a physical object that sits with the individual at their desk. When it is time to drink water, unlike app reminders, this reminder is not something that can just be ignored. This does not shut off until the indiviudal presses the button. Although this too, can just be disragarded, the chances of an invidual drinking their water from a system that has their water bottle present next to them and is a physical object, is substancially higher than that of an app that sends a simple notification.

What might be an interesting extension of this project? In what other contexts might this project be used? 

If this object were to be produced further and possibly brought into the world for indivudals to purchace, there are serveral aspects that could be improved. Firstly, using a more durable material would be extremely beneficial. This would also allow for users to successfully move the object or take it with them without it getting damaged easily. Another extension could be to add more outputs. At this time, there are only a few outputs. Adding in more outputs such as LED lights or music would assist in getting the users attention and would be more fun for the indivudal to use. This project could also be extended to more than just a water hydration system. This could become a reminder system for many things, a reminder to take medicine, a reminder to do chores etc. The compartment where the water bottle currently is could be optimised to suit all of these suggestions. 
